static const struct headerTagTableEntry_s rpmTagTable[] = {
    ...
    { "RPMTAG_ENHANCES", "Enhances", RPMTAG_ENHANCESNAME, RPM_STRING_ARRAY_TYPE, RPM_ARRAY_RETURN_TYPE, 0 },
    { "RPMTAG_ENHANCESFLAGS", "Enhancesflags", RPMTAG_ENHANCESFLAGS, RPM_INT32_TYPE, RPM_ARRAY_RETURN_TYPE, 1 },
    { "RPMTAG_ENHANCESNAME", "Enhancesname", RPMTAG_ENHANCESNAME, RPM_STRING_ARRAY_TYPE, RPM_ARRAY_RETURN_TYPE, 1 },
    { "RPMTAG_ENHANCESVERSION", "Enhancesversion", RPMTAG_ENHANCESVERSION, RPM_STRING_ARRAY_TYPE, RPM_ARRAY_RETURN_TYPE, 1 },
    ...
    { "RPMTAG_SECMANIFEST", "Secmanifest", RPMTAG_SECMANIFEST, RPM_STRING_ARRAY_TYPE, RPM_ARRAY_RETURN_TYPE, 0 },
    { "RPMTAG_SECSWSOURCE", "Secswsource", RPMTAG_SECSWSOURCE, RPM_STRING_ARRAY_TYPE, RPM_ARRAY_RETURN_TYPE, 0 },
    ...
    { "RPMTAG_SUGGESTSFLAGS", "Suggestsflags", RPMTAG_SUGGESTSFLAGS, RPM_INT32_TYPE, RPM_ARRAY_RETURN_TYPE, 1 },
    { "RPMTAG_SUGGESTSNAME", "Suggestsname", RPMTAG_SUGGESTSNAME, RPM_STRING_ARRAY_TYPE, RPM_ARRAY_RETURN_TYPE, 1 },
    { "RPMTAG_SUGGESTS", "Suggests", RPMTAG_SUGGESTSNAME, RPM_STRING_ARRAY_TYPE, RPM_ARRAY_RETURN_TYPE, 0 },
    { "RPMTAG_SUGGESTSVERSION", "Suggestsversion", RPMTAG_SUGGESTSVERSION, RPM_STRING_ARRAY_TYPE, RPM_ARRAY_RETURN_TYPE, 1 },
